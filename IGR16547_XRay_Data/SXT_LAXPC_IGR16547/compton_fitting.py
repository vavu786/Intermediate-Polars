...
# TODO: I don't think the compton model is fitting it properly.
# TODO: I had to add a gaussian to get it to fit the main peak and also the temperature is 35, which seems way off
...
set_source(3, (xstbabs.abs3 + xstbabs.abs4) * (xscompst.c2 + xsgaussian.g2 + powlaw1d.plax))
