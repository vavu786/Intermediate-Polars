...
# Models
set_source(1, (xstbabs.abs1 + xstbabs.abs2) * (xscompls.cmp1))
set_source(2, powlaw1d.p1 + powlaw1d.p2 + bkgg1 + bkgg2 + bkgg3)
set_source(3, (xstbabs.abs3 + xstbabs.abs4) * (((xscompls.cmp2) + xsgaussian.g2) + powlaw1d.plax))
...
'''
for i in range(1, 5):
    plot("fit", i, xlog=True)
    input("Press enter to continue:")

print("")

for j in range(1, 5):
    get_resid_plot(j).plot()
    input("Press enter to continue:")
'''
